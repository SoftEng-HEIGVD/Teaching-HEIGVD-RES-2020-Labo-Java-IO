...
public class Utils {
     ...
     * the end of line delimiters in the string and to keep the end of line delimiters.
     * <p>
    ...
    public static String[] getNextLine(String lines) {
        ...
        // If there are new line chars delimiters at the end of the lines
        if(splittedLines.length == 2)
            return splittedLines;
            // If there's no new line char delimiter at the end of a line, return the first line as empty
        else
