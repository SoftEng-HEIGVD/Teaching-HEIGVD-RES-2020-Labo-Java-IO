...
public class Utils {
    ...
    public static final Pattern UNIX_PATTERN = Pattern.compile(UNIX_SEPARATOR);
    public static final Pattern MAC_OS9_PATTERN = Pattern.compile(MAC_OS9_SEPARATOR);
    public static final Pattern WINDOWS_PATTERN = Pattern.compile(WINDOWS_SEPARATOR);
