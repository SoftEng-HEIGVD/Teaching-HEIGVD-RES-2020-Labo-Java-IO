...
public class Application implements IApplication {
  ...
  public void fetchAndStoreQuotes(int numberOfQuotes) throws IOException {
    ...
    for (int i = 0; i < numberOfQuotes; i++) {
       ...
       */
      storeQuote(quote, new File("quote-"+i+1+".utf8"));
   ...
   * @throws IOException
   */
  void storeQuote(Quote quote, File filename) throws IOException {
    ...
    OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream(filepath + "/" + filename), StandardCharsets.UTF_8);
    ...
    explorer.explore(new File(WORKSPACE_DIRECTORY), new IFileVisitor() {
      ...
      public void visit(File file) {
        ...
        try {
          ...
          LOG.log(Level.SEVERE, "Could not fetch filepath. {0}", ex.getMessage());
          ex.printStackTrace();
        }
      }
    });
