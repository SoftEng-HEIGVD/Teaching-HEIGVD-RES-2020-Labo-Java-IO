    ...
    void printFileNames(final Writer writer) {
        ...
        explorer.explore(new File(WORKSPACE_DIRECTORY), new IFileVisitor() {
            ...
            public void visit(File file) {
                /*
                 * There is a missing piece here. Notice how we use an anonymous class here. We provide the
                 * implementation
                 * of the the IFileVisitor interface inline. You just have to add the body of the visit method, which
                 *  should
