    ...
    explorer.explore(new File(WORKSPACE_DIRECTORY), new IFileVisitor() {
      ...
      public void visit(File file) {
        ...
        try {
          ...
          // writer.write(System.lineSeparator()); // Deleted to pass the following test :
          writer.write("\n"); // Fixed this to pass the theApplicationShouldBeAbleToGenerateTheListOfFileNames
                              // Test. On windows system it writes \r\n and the tests wants only \n.
