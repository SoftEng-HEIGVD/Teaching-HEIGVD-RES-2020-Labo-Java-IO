...
public class CompleteFileTransformer extends FileTransformer {
   ...
   * of the writer (connected to the file. You can see that you first decorate the writer with an UpperCaseFilterWriter,
   * which you then decorate with a FileNumberingFilterWriter. The resulting writer is used by the abstract class to
   * write the characters read from the input files.
